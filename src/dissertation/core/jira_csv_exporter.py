...
def export_jira_csv(
    ...
    - Scenarios are included inside each story's description (no subtasks)
    ...
    with out_path.open("w", newline="", encoding="utf-8") as f:
        ...
        # 2) Stories (linked to epic) + embed scenarios into Description
        for us in req.stories:
            story_text = us.story_text  # ✅ your schema
            summary = f"{us.story_id} {story_text[:60]}".strip()

            desc_parts = [story_text, ""]
